  ...
  const saveAccountToLocalStorage = (accountProfile: UserProfile) => {
    try {
      ...
      const accountItem: SavedAccount = {
        ...
        equippedUniform: accountProfile.equippedUniform,
        equippedFrame: accountProfile.equippedFrame,
        equippedBackground: accountProfile.equippedBackground,
        equippedFaceAccessory: accountProfile.equippedFaceAccessory,
        avatarAccessories: accountProfile.avatarAccessories,
